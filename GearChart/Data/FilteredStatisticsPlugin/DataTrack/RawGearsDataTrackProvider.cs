...
{
    class RawGearsDataTrackProvider
    {
        public RawGearsDataTrackProvider()
        {
...
#region IActivityDataTrackProvider Members
        ...
        {
            get { return new Guid("8b69f42d-3764-43bd-83a0-8522669c2ae8"); }
        }
        ...
        public string YAxisLabel
        {
            get
            {
                return Strings.GearRatioRawText;
            }
        }
        ...
        public INumericTimeDataSeries SmoothedDataTrack
        {
            get
            {
                if (m_Activity != null)
                {
                    INumericTimeDataSeries tempResult = GearChart.Common.Data.GetRawGearTrack(m_Activity);
